...
3. Open the file `_header.scss` found under **/assets/styles/templates/partials**
...
5. Create a new file called `_button.scss` in the folder **/assets/styles/components**
...
7. Open the file `_components.scss` found under **/assets/styles**

8. Add the `_button.scss` file to the list of components
...
9. Now when we have common button styles we need to adjust our header menu button a little. Open `_header.scss` file found under **/assets/styles/templates/** partials again and add button modifications within `.t-header__menu block`
...
10. Repeat steps 3-6 to add another component called `_cart-count` with the following styles:
